/**
 * GET /v2/trades/live — currently open/live trades
 */
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const rows = await sql`
      ...
      WHERE t.integrity = 'live'
        AND t.tweet_deleted_at IS NULL
    ...
    return v2Error("SERVER_ERROR", "Failed to fetch live trades", 500, auth.rateLimitHeaders);
  }
}
